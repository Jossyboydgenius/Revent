# Revent ENS Integration (Durin) 🏷️

<div align="center">
  <img src="https://github.com/user-attachments/assets/4f01ef6e-3c1e-4201-83db-fac4b383a3b0" alt="durin" width="33%">
</div>

**ENS L2 Subname Management for Revent Platform**

This component provides decentralized naming infrastructure for the Revent platform, enabling users to create and manage ENS subnames on Layer 2 networks. Built on Durin, an opinionated approach to ENS L2 subnames, it consists of:

1. **Registry Factory** on [supported chains](#active-registry-factory-deployments) for deploying event-specific registries
2. **Registrar Template** for custom event naming and access control
3. **Gateway Server** for CCIP Read resolution between L1 and L2
4. **L1 Resolver** for seamless cross-chain name resolution

## 🎯 Revent Integration

The ENS integration enables Revent users to:
- **Create event-specific subnames** (e.g., `ethaccra.revent.eth`)
- **Decentralized event discovery** through ENS resolution
- **Cross-chain name resolution** between mainnet and L2 networks
- **IPFS metadata linking** for rich event information storage

## 🚀 Quick Start for Revent Events

### For Event Creators

Create ENS subnames for your events to enable decentralized discovery and branding:

1. **Deploy Event Registry**: Create a dedicated registry for your event organization
2. **Enable Name Resolution**: Connect your L2 registry with mainnet ENS
3. **Create Event Subnames**: Generate memorable names for individual events
4. **Link IPFS Metadata**: Connect event information stored on IPFS

## 📋 Deployment Instructions

This component works in conjunction with [Durin.dev](https://durin.dev/) for registry deployment, or can be deployed independently for Revent-specific use cases.
